   ...
   String store_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().hasExtra("store_id"))
        {
            ...
            Boolean offerType = getIntent().getBooleanExtra("offer_type", false);
            offer_id = getIntent().getStringExtra("offer_id");
            Log.i("check","Check ven :"+offer.vendor_id);
            Log.i("check","Check offty :"+offerType);
        }
    ...
    {
        Log.d("TYU", "check value :"+ offer.offer_id + "store "+ store_id + " offerTy " + offer.IsOfferLocal);
       ...
       private void showAlert(){
          ...
          // store = synceddb.getStoreInfo(stores);
           ...
           Log.d("TAG","old vendor  :"+offer.name);
           Log.i("Hii ","all Barcode :"+qrcodes);
...
//                   Log.i("MAYANK :"," checking :" +offer.remaining_codes);
                       Class_Store store;
                       store = synceddb.getStoreInfo(store_id);
    ...
    public  Class_Offer_Store CheckOrCreateOffer(){
        return synceddb.modify_local_offer(store_id, offer,offer_id,id);
    }
